				...
				<!-- User Account Menu -->
					<li class="dropdown user user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<img src="/files/{{ auth()->user()->profile_img }}" class="user-image" alt="User Image">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								<img src="/files/{{ auth()->user()->profile_img }}" class="img-circle" alt="User Image">
								<p>{{ auth()->user()->name }}</p>
							</li>
							<!-- Menu Footer-->
							<li class="user-footer">
								<div class="pull-left">
									...
									{{--<form id="profile-form" action="{{ route('profile') }}" method="GET" class="hide">--}}
