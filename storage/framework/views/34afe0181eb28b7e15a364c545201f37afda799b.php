					...
					<?php if($countNotifications): ?>
						<li class="dropdown notifications-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="footer"><a
											href="<?php echo e(route('notifications.index', [auth()->id()])); ?>"><?php echo app('translator')->getFromJson('View'); ?></a>
								</li>
							</ul>
						</li>
				<?php endif; ?>
					...
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-footer">
								<div class="pull-left">
									<a id="profile" href="<?php echo e(route('admin.profile', [auth()->user()->id])); ?>"
									   class="btn btn-default btn-flat"><?php echo app('translator')->getFromJson('Profile'); ?></a>
	...
	<aside class="main-sidebar">
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li><a href="<?php echo e(route('categories.index')); ?>"><i class="fa fa-list"></i>
						<span><?php echo app('translator')->getFromJson('Categories'); ?></span></a></li>
				...
				<li><a href="<?php echo e(route('medias.index')); ?>"><i class="fa fa-image"></i> <span><?php echo app('translator')->getFromJson('Medias'); ?></span></a>
				</li>

				<?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?>
				<li><a href="<?php echo e(route('settings.edit')); ?>"><i class="fa fa-cog"></i> <span><?php echo app('translator')->getFromJson('Settings'); ?></span></a>
				</li>
				<?php endif; ?>
				...
				<?php if($countNotifications): ?>
					<li><a href="<?php echo e(route('notifications.index', [auth()->id()])); ?>"><i class="fa fa-bell"></i>
							<span><?php echo app('translator')->getFromJson('Notifications'); ?></span></a></li>
				<?php endif; ?>
