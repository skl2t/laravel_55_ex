...
Route::get('category/{category}', 'Front\PostController@category')->name('category');
...
Route::prefix('admin')->namespace('Back')->group(function () {
	...
	Route::group(['middlewareGroups' => ['web']], function () {
		Route::name('profile.edit')->post('edit', 'UserController@editUser');
	});
	
	Route::middleware('redac')->group(function () {
		Route::name('admin')->get('/', 'AdminController@index');
		Route::name('admin.profile')->get('profile/{id}', 'UserController@getUserInfo');
